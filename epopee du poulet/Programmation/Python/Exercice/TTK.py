...
# L'affichage du texte de l'état de la connexion avec 'age' et non 'delret'

# Fonction setport modifiée pour mettre à jour 'age' et non 'delret'
def setport():
    global ser
    try:
...
wt = Label(win, text="waiting:", font=("Verdana", 8), fg="#d3deda", bg="#1c1700")
wt.place(y=625, x=10)

global comport
comport = StringVar()
selectCom = Entry(win, textvariable=comport, width=20)
selectCom.place(x=125, y=648)
setButton = Button(win, text="submit", font=("Verdana", 19, "bold italic"), bd=0, command=setport, width=7, height=1, bg="#000000", fg="white", activebackground="#b8e6d2")
setButton.place(x=300, y=640)
